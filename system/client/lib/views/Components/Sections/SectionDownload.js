...
// core components
import styles from "assets/jss/clear-crm/views/componentsSections/downloadStyle.js";
        ...
        <GridContainer className={classes.textCenter} justify="center">
          ...
          <GridItem xs={12} sm={8} md={6}>
            <Button
              color="primary"
              size="lg"
              href="https://www.creative-tim.com/product/clear-crm?ref=mkr-download-section"
              target="_blank"
            >
              Free React Download
            </Button>
