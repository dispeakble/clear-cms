...
paths="/var/lib/etcd /etc/kubernetes /etc/cni /opt/cni /var/lib/cni /var/run/calico /opt/rke $HOME/rancher/rancher-store /var/lib/rancher $HOME/cms_app /usr/bin/rancher /var/lib/longhorn"
