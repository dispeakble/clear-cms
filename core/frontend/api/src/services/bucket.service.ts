...
export class BucketService {
    ...
    private methods = ["checkAccess", "getMeta", "info", "get", "list", "completePath", "upload", "read", "download"];
    ...
    constructor(
        ...
        this.help = this.helpService.help;
    }
    ...
    public getMeta(data: any) {
        ...
        return new Promise((resolve) => {
            ...
            try {
                ...
                if (this.help.is.dir({path: file_path}) || !this.help.is.readable({path: file_path})) {
                    file_name = this.defaultPath;
                    file_path = path.join(__dirname, '..', '..', 'public', this.defaultPath);
                }
    ...
    public get(data: any) {
        return new Observable((observer) => {
            ...
            try {
                ...
                fs.readFile(path.join(__dirname, '..', '..', 'public', this.defaultPath), (err, buffer) => {
