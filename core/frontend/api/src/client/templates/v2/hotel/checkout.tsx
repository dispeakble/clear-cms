...
const HotelCheckoutPage = ({ websiteName, colorScheme }: any) => {
  ...
  const displayHeader = () => {
    switch (currentStep) {
      case 1 :
        return t("hotelCheckout.headers.first");
      case 2 :
        return t("hotelCheckout.headers.second");
      case 3 :
        return t("hotelCheckout.headers.third");
      case 4 :
        if (paymentError) {
      ...
      case 5:
        return t("hotelCheckout.headers.confirmed");
    }
  };
  ...
  const displayStep = () => {
    switch (currentStep) {
      case 1:
        return <FirstStep hotelData={hotelData}
