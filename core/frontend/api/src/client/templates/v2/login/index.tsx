...
const LoginPage = ({ websiteName, websiteSlogan, colorScheme, recaptchaKey }: any) => {
          ...
          (
            <>
              <ReCAPTCHA
                ...
                ref={reCAPTCHARef}
              />
              <Layout websiteName={websiteName} websiteSlogan={websiteSlogan} colorScheme={colorScheme}
                      breadcrumbs={breadcrumbs} isLogin isOrange>
                <PaperWrapper>
                  <ContentWrapper>
                    <LoginWrapper>
                      <ImageContainer>
                            ...
                            {({ errors, isSubmitting }: any) => (
                              <Form style={{ width: "100%" }}>
                                <Container>
                                        ...
                                        <Field name={`password`}>
                                          {({ field }: any) => (
                                            <TextInput {...field} required
                                                       ...
                                                       placeholder={t("input.placeholder.login.password")}
                                                       icon="loginPassword" type={showPassword ? `text` : `password`} />
                                          )}
                                        </Field>
                                        <ShowPasswordContainer onClick={() => setShowPassword(!showPassword)}
                                                               data-testid={"test-toggle-password-visibilty"}>
                                          <ShowPasswordIcon src={ShowPassword} alt={"show-password"} width={20}
                                                            height={18} />
                                  ...
                                  <div>
                                    <ButtonContainer>
                                      <ContinueButton data-testid="test-login-button" disabled={isSubmitting}
