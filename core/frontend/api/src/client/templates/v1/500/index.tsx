...
import Img500 from "../assets/img/image500.jpg"
import Img500Right from "../assets/img/image500Right.png"
        ...
        <ThemeProvider theme={myTheme}>
            ...
            <MainWrapper data-testid="custom300-page-wrapper">
                <TopContentWrapper>
                    ...
                    <StyledContainer>
                        <StyledErrorImageContainer>
                            <Image src={Img500} alt="image-500"/>
                        </StyledErrorImageContainer>
                        <ContentContainer>
                            <StyledHeader>
                                {t('custom500.header')}
                        ...
                        <StyledErrorImageContainer>
                            <Image src={Img500Right} alt="image-500"/>
                        </StyledErrorImageContainer>
                    </StyledContainer>
                <Footer />
            </MainWrapper>
