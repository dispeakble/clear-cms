          ...
          return (
            <FlightDetailsWrapper key={index}>
              ...
              <FlightExpandDetails expand={isOpen === index}>
                <FlightDescriptionContainer>
                  <FlightDescription>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer eu dolor efficitur, ullamcorper
                    lectus id, consectetur purus. Cras consequat dapibus aliquam. Aenean hendrerit convallis ultrices.
                    Praesent scelerisque orci vel arcu tincidunt, eu facilisis massa pellentesque. Ut facilisis sem
                    ipsum, vitae porta enim dignissim consequat. Etiam nec placerat nibh. Aliquam posuere auctor lacus
                    vitae sollicitudin. Quisque facilisis accumsan sapien ac efficitur. Etiam eget urna vulputate,
                    faucibus ipsum et, imperdiet ipsum. Nam eu nunc a erat tincidunt feugiat sit amet id lacus. Nunc id
                    risus vitae neque dictum eleifend eu quis felis.
                  </FlightDescription>
                </FlightDescriptionContainer>
              </FlightExpandDetails>
              <FlightInfosContainer>
