...
const InvoicePage = ({ websiteName, colorScheme, websiteSlogan }: any) => {
  ...
  return (
    <Layout websiteName={websiteName} websiteSlogan={websiteSlogan} colorScheme={colorScheme} breadcrumbs={breadcrumbs}
            isLogin>
      <InvoicePageWrapper>
        <TableContainer>
          <MaterialTable
