      ...
      <DealCard>
        ...
        <EditDeals>
          <Destination>
            ...
            <HotelSearch>
              <SearchIcon />
              <input value={data.hotel} data-testid="hotelInput" type="search" placeholder={t("deals.hotel")}
                     onChange={(e) => {
                        ...
                        <Person>
                          ...
                          <BoxRight>
                            <Quantity>
                              ...
                              <h5
                                data-testid="adultNumberFromDropdown">{data?.passenger.adults < 10 ? `0${data?.passenger.adults}` : data?.passenger.adults}</h5>
                        ...
                        <Person>
                          ...
                          <BoxRight>
                            <Quantity>
                              ...
                              <h5
                                data-testid="childNumberFromDropdown">{data?.passenger.children < 10 ? `0${data?.passenger.children}` : data?.passenger.children}</h5>
          ...
          <NewSearch>
            <button><WhiteIcon /><Link to="prices" spy={true}
                                       smooth={true}><span>{t("hotelDetail.hotelDetailComponent.newSearch")}</span></Link>
            </button>
          </NewSearch>
          ...
          <LeftSide>
            ...
            <ShortDescription>
              ...
              <ViewMap><Link to="showmap" spy={true}
                             smooth={true}>{t("hotelDetail.hotelDetailComponent.showMap")}</Link></ViewMap>
            </ShortDescription>
          </LeftSide>
          <ViewPrice>
            <StyledButton>
