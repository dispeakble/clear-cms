      ...
      <BottomSection>
        <Container>
          <BottomSectionWrapper>
            ...
            <LinkList>
              {
                sitemapLinks.map((link: any, index: number) => <li key={`${index}`}><LinkItem
                  href={link.linkURL}>{link.text}</LinkItem></li>)
              }

            </LinkList>
            <LinkList>
              {
                impLinks.map((link: any, index: number) => <li key={`${index}`}><LinkItem
                  href={link.linkURL}>{link.text}</LinkItem></li>)
              }
            </LinkList>
            <LinkList>
