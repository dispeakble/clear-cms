  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div className={classes.root}>
          <Button color="primary" className={classes.button} variant="text">
            <AddIcon />
          </Button>
          <Button color="secondary" className={classes.button} variant="text">
            <DeleteIcon />
          </Button>
          <Button disabled className={classes.button} variant="text">
            <NavigationIcon />
          </Button>
          <Button href="#text-buttons" className={classes.button} variant="text">
            Link
          </Button>
        </div>
      </React.Fragment>
