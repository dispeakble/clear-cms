                ...
                <div className="clear-crm_search-bar">
                    <div className="clear-crm_search-bar--search">
                        ...
                        <div className="search-input">
                            <input type="text" placeholder="Search..." value={this.state._search} onChange={this.onChangeHandler}/>
                        </div>
                        <div className="search-clear" ref={this.clearSearchBtn} onClick={this.clearSearch}>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                 stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                                 className="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6"
                                                                                                                y1="6"
                                                                                                                x2="18"
                                                                                                                y2="18"></line></svg>
                        </div>
